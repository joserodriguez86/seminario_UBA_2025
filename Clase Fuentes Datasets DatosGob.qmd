---
title: "Clase 2 - Introducción al uso y aplicación de paquetes estadísticos para el tratamiento de fuentes de información en investigación social cuantitativa"
...
## 1.1. ESTABLECIMIENTOS PRODUCTIVOS

-   La metodología hace referencia a las definiciones conceptuales del proceso de recolección de la información. En este caso...

-   El diccionario del archivo de datos, es fundamental para comprender a qué hace referencia cada uno de las variables de recurso como así también para entender la codificación de los datos. En este caso...

-   A continuación...

## 1.2. ESTABLECIMIENTOS PRODUCTIVOS
...
serv_penitenciario <- read.csv(ruta_5, sep = ",")
