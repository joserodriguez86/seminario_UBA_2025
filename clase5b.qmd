---
title: "Clase 5b - Introducción al uso y aplicación de paquetes estadísticos para el tratamiento de fuentes de información en investigación social cuantitativa"
...
La opción [na.rm = TRUE]{.mark} nos permite descartar los casos que no son válidos o perdidos del cálculo, en este caso, del promedio.  
...
**Porcentaje de personas que asisten a museos (pág. 38)**: Calcularemos el porcentaje de personas que asisten a museos según nivel socio-económico. Para ello, utilizaremos la variable *pat1* y *nse_3*. Recordar que debemos utilizar el *ponderador* para realizar las estimaciones correctas.
...
Para poder quedarnos únicamente con el mes de mayo y el año 2025 debemos aplicar un filtro, para luego poder agrupar los datos. Finalmente haremos la sumatoria, adentro de cada país de destino, de la cantidad de viajes identificados en la variable *viajes_de_turistas_residentes*.  
